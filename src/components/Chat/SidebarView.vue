...
<template>
  <div>
    <div class="field px-1">
      <p class="control has-icons-left is-size-7-mobile">
        <input class="input is-size-6 is-size-7-mobile" type="text" placeholder="Search" v-model="searchInput" spellcheck="false"
    ...
    <div class="chats-container">
      ...
      <div @click="toggleArchived" v-if="isArchivedOpen" class="close-archived-chat has-background-danger p-4"
      ...
      <div @click="toggleArchived" v-else class="archived-chat has-background-grey-light has-text-white p-2"
        onselectstart="return false" onpaste="return false;" onCopy="return false" onCut="return false"
        onDrag="return false" onDrop="return false">
        <div class="is-flex">
