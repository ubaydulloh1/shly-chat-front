            ...
            <form action="" @submit.prevent="handleSubmit">
                ...
                <div class="field">
                    <p class="control has-icons-left has-icons-right">
                        <input class="input is-success" type="text" placeholder="Enter your username" autocomplete="off"
                            v-model="user.username" @input="checkUsername">
                ...
                <div class="field">
                    <p class="control has-icons-left">
                        <input class="input is-success" type="text" placeholder="Enter your firstname" autocomplete="off"
                ...
                <div class="field">
                    <p class="control has-icons-left">
                        <input class="input is-success" type="text" placeholder="Enter your lastname" autocomplete="off"
                ...
                <div class="field">
                    <p class="control has-icons-left has-icons-right">
                        <input class="input is-success" v-if="!showPassword" type="password"
                            placeholder="Confirm your password" v-model="user.passwordConfirm">
                        <input class="input is-success" v-else type="text" placeholder="Enter your password"
